/* empty css                          */
import { e as createAstro, f as createComponent, r as renderTemplate, j as renderComponent, m as maybeRenderHead } from '../astro_Dhi2w44Q.mjs';
import 'kleur/colors';
...
const $$Services = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<article class="container mx-auto lg:px-16"> <h1>Our Services</h1> <p>
...
}, "/Users/jesse/Sites/github/avalanche-hardwood-floors/src/pages/services.astro", void 0);

const $$file = "/Users/jesse/Sites/github/avalanche-hardwood-floors/src/pages/services.astro";
const $$url = "/services";
